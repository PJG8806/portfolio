...
| # | 프로젝트 | 한 줄 소개 | 기간 | 역할 |
|---|----------|-----------|------|------|
| 1 | [FRAGMNT](#1-fragmnt---ai-향수-추천-플랫폼) | AI 기반 개인 맞춤 향수 추천 플랫폼 | 2025 | 백엔드 리더 |
| 2 | [사자사자 가계부](#2-사자사자-가계부---금융-교육-가계부-서비스) | 부모-자녀 함께 사용하는 금융 교육 가계부 | 2026.02 | 백엔드 (finance / contents 도메인) |
| 3 | [LMS 커뮤니티](#3-lms-커뮤니티---게시글-cud-담당) | Django 기반 LMS 커뮤니티 백엔드 | 2025.03 | 백엔드 (게시글 CUD) |
...
- **Vector-like Filtering**: AI 입력 전 유사도 상위 후보만 선별해 토큰 사용량과 응답 시간 최적화 (30초 → 10초)
- **OG 공유 시스템**: Hashids 기반 ID 암호화 + 7일 TTL 만료 관리로 카카오톡/SNS 공유 지원

---

## 2. 사자사자 가계부 - 금융 교육 가계부 서비스
...
- **테스트**: 인증/권한/중복 방지/소유권 검증 등 핵심 기능 68개 테스트 전체 통과

---

## 3. LMS 커뮤니티 - 게시글 CUD 담당
