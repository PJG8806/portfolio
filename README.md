...
| 2 | [LMS 커뮤니티](#3-lms-커뮤니티---게시글-cud-담당) | Django 기반 LMS 커뮤니티 백엔드 | 2026.03 | 백엔드 (게시글 CUD) |
| 3 | [사자사자 가계부](#2-사자사자-가계부---금융-교육-가계부-서비스) | 부모-자녀 함께 사용하는 금융 교육 가계부 | 2026.02 | 백엔드 (finance / contents 도메인) |
